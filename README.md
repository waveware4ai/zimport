...
2025/06/xx v0.1.? : support (diffusers package; https://github.com/huggingface/diffusers)

Support & Tested Package
------------
The following major packages have been tested:  
|package name <br> (with dependency)|test environment|zimport implemented version|support status <br> (Ｏ, △, Ⅹ)|
|:---:|:---:|:---:|:---:|
